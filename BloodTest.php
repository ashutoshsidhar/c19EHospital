...
<body>
	...
	<h1>Blood Test</h1>
	<p>A person will come to collect sample</p>
	</div>
	</div>
	<div class='container'>
	<form action ='BTdb.php' method='POST'>
	...
	<div class='form-group'>
	<label for='description'>Test Type</label>
	...
	<input class ='form-control' id='add' name='add' type='text'>
	</div>
	<div class='form-group'>
	<label for='date'>Date for test</label>
